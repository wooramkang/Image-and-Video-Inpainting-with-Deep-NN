...
def ResNet(input_shape=None,  block='bottleneck', residual_unit='v2',
...
def Encoder(input_shape):
    if (input_shape[0] < 224):
        return ResNet(input_shape, bottleneck, repetitions=[3, 4, 6, 3], initial_filters= int((input_shape[0]/224) * 64) )

    return ResNet(input_shape, bottleneck, repetitions=[3, 4, 6, 3], initial_filters= 64 )
